...
class DogEssentials extends StatefulWidget {
  const DogEssentials({super.key});

  @override
  State<DogEssentials> createState() => _DogEssentialsState();
}

class _DogEssentialsState extends State<DogEssentials> {
  int selectedTab = 0;
